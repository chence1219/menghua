...
// #endif  
    ...
    virtual void SetMode(const std::string& mode_name) override;

    // High temperature warning methods
    virtual void ShowHighTempWarning() override;
    virtual void HideHighTempWarning() override;
};
