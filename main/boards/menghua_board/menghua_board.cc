...
class Menghua_Board : public WifiBoard {
private:
    ...
    void InitializePowerManager() {
        ...
        // 注册高温报警回调
        power_manager_->OnHighTempAlarm([this](bool alarm_on) {
            if (alarm_on) {
                ESP_LOGW(TAG, "High temperature alarm triggered, showing warning popup");
                display_->ShowHighTempWarning();
            } else {
                ESP_LOGI(TAG, "High temperature alarm cleared, hiding warning popup");
                display_->HideHighTempWarning();
            }
        });
